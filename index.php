            ...
            <?php foreach ($goods as $good =>$value):  ?>
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src=<?php echo $value['url']; ?> width="350" height="260" alt=<?php echo $value['description']; ?>>
                    </div>
                    <div class="lot__info">
                        <span class="lot__category"><?php echo $value['categorie']; ?></span>
                        <h3 class="lot__title"><a class="text-link" href="lot.html"><?php echo $value['productName']; ?></a></h3>
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount">Стартовая цена</span>
                                <span class="lot__cost"><?php echo fun($value['price']); ?></span>
                            </div>
